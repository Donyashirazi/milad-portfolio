const AllProjects = [
		...
		tabs: {
			nonTechnicalSummery: {
				...
				content2: {
					...
					image: 'public/images/project1/dci1.png',
					imageDescription:
				...
				content3: {
					...
					image: 'public/images/project1/bj1.png',
					imageDescription:
				...
				content4: {
					...
					image: 'public/images/project1/video.png',
					imageDescription:
				...
				content5: {
					...
					image: 'public/images/project1/kpi1.png',
					imageDescription: '',
					lastContent: '',
				},
				content6: {
					title: '',
					description: '',
					image: 'public/images/project1/kpi2.png',
					imageDescription: '',
					lastContent: '',
				},
				content7: {
					...
					image: 'public/images/project1/unity.png',
					imageDescription: '',
					lastContent: '',
				},
			},
			...
			result: {
				content1r: {
					...
					image: 'public/images/project1/result1.png',
					imageDescription:
				...
				content2r: {
					title: '',
					description: '',
					image: 'public/images/project1/result2.png',
					imageDescription:
				...
				content3r: {
					...
					image: 'public/images/project1/hpdashboard.png',
					imageDescription:
				...
				content4r: {
					...
					image: 'public/images/project1/dcidashboard.png',
					imageDescription: '',
					lastContent: '',
				},
				content5r: {
					...
					image: 'public/images/project1/bj2.png',
					imageDescription:
				...
				content6r: {
					...
					image: 'public/images/project1/kpidashboard.png',
					imageDescription:
				...
				content7r: {
					...
					image: 'public/images/project1/all1.png',
					imageDescription:
				...
				content8r: {
					...
					image: 'public/images/project1/all2.png',
					imageDescription:
...

	{
		id: '2',
		status: 'done',
		image: 'public/images/Futsal.jpg',
		...
		tabs: {
			nonTechnicalSummery: {
				content1: {
					...
					image: 'public/images/project2/futsal.png',
					imageDescription:
				...
				content2: {
					...
					image: 'public/images/project2/lineup.png',
				...
				content3: {
					...
					image: 'public/images/project2/matchreport.png',
					imageDescription: '',
					lastContent: '',
				},
				content4: {
					...
					image: 'public/images/project2/playercards.png',
					imageDescription: '',
					lastContent: '',
				},
				content5: {
					...
					image: 'public/images/project2/wincontribution.png',
				...
				content6: {
					...
					image: 'public/images/project2/pair1.png',
				...
				content7: {
					title: '',
					description: '',
					image: 'public/images/project2/pair2.png',
					imageDescription: '',
					lastContent: '',
				},
				content8: {
					title: '',
					description: '',
					image: 'public/images/project2/pair3.png',
				...
				content9: {
					title: '',
					description: '',
					image: 'public/images/project2/pair4.png',
					imageDescription:
				...
				content10: {
					...
					image: 'public/images/project2/AIopinion.png',
					imageDescription:
				...
				content11: {
					...
					image: 'public/images/project2/announce.png',
					imageDescription:
				...
				content12: {
					...
					image: 'public/images/project2/recommended.png',
					imageDescription:
				...
				content13: {
					...
					image: 'public/images/project2/bests.png',
					imageDescription:
			...
			result: {
				content1r: {
					...
					image: 'public/images/project2/results1.png',
					imageDescription:
		...
		tabs: {
			nonTechnicalSummery: {
				...
				content2: {
					...
					image: 'public/images/project3/schema.png',
					imageDescription: '',
					lastContent:
				...
				content5: {
					...
					image: 'public/images/project3/credibility.png',
					imageDescription:
				...
				content6: {
					...
					image: 'public/images/project3/collaborative.png',
					imageDescription:
				...
				content7: {
					...
					image: 'public/images/project3/dbscan.png',
					imageDescription:
				...
				content8: {
					...
					image: 'public/images/project3/knn.png',
					imageDescription: '',
					lastContent:
				...
				content9: {
					...
					image: 'public/images/project3/map.png',
					imageDescription:
				...
				content10: {
					title: '',
					description: '',
					image: 'public/images/project3/map1.png',
					imageDescription: '',
					lastContent: '',
				},
				content11: {
					title: '',
					description: '',
					image: 'public/images/project3/map2.png',
					imageDescription:
			...
			result: {
				content1r: {
					...
					image: 'public/images/project3/reports.png',
					imageDescription:
				...
				content2r: {
					...
					image: 'public/images/project3/pasargad.png',
					imageDescription:
				...
				content3r: {
					...
					image: 'public/images/project3/iranzamin.png',
					imageDescription:
						'Image of the location where google map showed a bank, but our data did not.',
					lastContent: '',
				},
